...
#define SREF_0              (0x0 /* 0*0x2000 */)  /* VR+ = AVCC and VR- = AVSS */
#define SREF_1              (0x2000 /* 1*0x2000 */)  /* VR+ = VREF+ and VR- = AVSS */
#define SREF_2              (0x4000 /* 2*0x2000 */)  /* VR+ = VEREF+ and VR- = AVSS */
#define SREF_3              (0x6000 /* 3*0x2000 */)  /* VR+ = VEREF+ and VR- = AVSS */
#define SREF_4              (0x8000 /* 4*0x2000 */)  /* VR+ = AVCC and VR- = VREF-/VEREF- */
#define SREF_5              (0xa000 /* 5*0x2000 */)  /* VR+ = VREF+ and VR- = VREF-/VEREF- */
#define SREF_6              (0xc000 /* 6*0x2000 */)  /* VR+ = VEREF+ and VR- = VREF-/VEREF- */
#define SREF_7              (0xe000 /* 7*0x2000 */)  /* VR+ = VEREF+ and VR- = VREF-/VEREF- */
...
#define ADC10DIV_0          (0*0x20)    /* ADC10 Clock Divider Select 0 */
#define ADC10DIV_1          (1*0x20)    /* ADC10 Clock Divider Select 1 */
#define ADC10DIV_2          (2*0x20)    /* ADC10 Clock Divider Select 2 */
#define ADC10DIV_3          (3*0x20)    /* ADC10 Clock Divider Select 3 */
#define ADC10DIV_4          (4*0x20)    /* ADC10 Clock Divider Select 4 */
#define ADC10DIV_5          (5*0x20)    /* ADC10 Clock Divider Select 5 */
#define ADC10DIV_6          (6*0x20)    /* ADC10 Clock Divider Select 6 */
#define ADC10DIV_7          (7*0x20)    /* ADC10 Clock Divider Select 7 */
...
#define INCH_0              (0x0 /* 0*0x1000 */)  /* Selects Channel 0 */
#define INCH_1              (0x1000 /* 1*0x1000 */)  /* Selects Channel 1 */
#define INCH_2              (0x2000 /* 2*0x1000 */)  /* Selects Channel 2 */
#define INCH_3              (0x3000 /* 3*0x1000 */)  /* Selects Channel 3 */
#define INCH_4              (0x4000 /* 4*0x1000 */)  /* Selects Channel 4 */
#define INCH_5              (0x5000 /* 5*0x1000 */)  /* Selects Channel 5 */
#define INCH_6              (0x6000 /* 6*0x1000 */)  /* Selects Channel 6 */
#define INCH_7              (0x7000 /* 7*0x1000 */)  /* Selects Channel 7 */
#define INCH_8              (0x8000 /* 8*0x1000 */)  /* Selects Channel 8 */
#define INCH_9              (0x9000 /* 9*0x1000 */)  /* Selects Channel 9 */
#define INCH_10             (0xa000 /* 10*0x1000 */) /* Selects Channel 10 */
#define INCH_11             (0xb000 /* 11*0x1000 */) /* Selects Channel 11 */
#define INCH_12             (0xc000 /* 12*0x1000 */) /* Selects Channel 12 */
#define INCH_13             (0xd000 /* 13*0x1000 */) /* Selects Channel 13 */
#define INCH_14             (0xe000 /* 14*0x1000 */) /* Selects Channel 14 */
#define INCH_15             (0xf000 /* 15*0x1000 */) /* Selects Channel 15 */
...
#define CCIS_0              (0x0 /* 0*0x1000 */) /* Capture input select: 0 - CCIxA */
#define CCIS_1              (0x1000 /* 1*0x1000 */) /* Capture input select: 1 - CCIxB */
#define CCIS_2              (0x2000 /* 2*0x1000 */) /* Capture input select: 2 - GND */
#define CCIS_3              (0x3000 /* 3*0x1000 */) /* Capture input select: 3 - Vcc */
#define CM_0                (0x0 /* 0*0x4000 */) /* Capture mode: 0 - disabled */
#define CM_1                (0x4000 /* 1*0x4000 */) /* Capture mode: 1 - pos. edge */
#define CM_2                (0x8000 /* 2*0x4000 */) /* Capture mode: 1 - neg. edge */
#define CM_3                (0xc000 /* 3*0x4000 */) /* Capture mode: 1 - both edges */
